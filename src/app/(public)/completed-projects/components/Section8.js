    ...
    // Financial & Ownership
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> DLD Mollak Service Charge Index (Q4 2025)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> DXBInteract DLD transaction data (Q1 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> DLD buyer's guide, RERA regulations</p>
            </>
        ),
    },
    ...
    // Community & Lifestyle
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> Emaar Community Management disclosures, aggregated resident feedback (Q1 2025–Q1 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                <p className="mb-2 font-semibold">Pros:</p>
                ...
                <p className="mb-2 font-semibold">Cons:</p>
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> Aggregated verified resident feedback (Q1 2025–Q1 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> Emaar Community Management records, resident feedback (Q1 2025–Q1 2026)</p>
            </>
        ),
    },
    ...
    // Location & Amenities
    {
        ...
        a: (
            <>
                        ...
                        <tbody className="divide-y" style={{ borderColor: 'rgba(0,0,0,0.08)' }}>
                            {[
                                ...
                                <tr key={school} className="hover:bg-gray-50 transition-colors">
                                    <td className="px-3 py-2 font-medium">{school}</td>
                ...
                <p className="mt-3 text-xs"><strong>Note:</strong> No school is within walking distance; all require vehicular transport. <strong>Source:</strong> KHDA School Directory 2025; drive times validated via Google Maps (February 2026).</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                <p className="mb-2 font-semibold">Retail (All Operational):</p>
                <ul className="list-disc pl-5 space-y-1 text-sm mb-4">
                ...
                <p className="mb-2 font-semibold">Healthcare (All Operational):</p>
                <ul className="list-disc pl-5 space-y-1 text-sm">
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> Google Business listings verified February 2026; RTA infrastructure records.</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-sm"><strong>Consideration:</strong> Daily convenience (groceries, pharmacies) requires driving; families prioritising walkable retail may prefer more urban communities.</p>
                <p className="mt-3 text-xs"><strong>Source:</strong> Aggregated verified resident feedback (Q1 2025–Q1 2026)</p>
            </>
        ),
    },
    ...
    // Investment & Resale
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> DXBInteract transaction analysis (Q1 2025–Q1 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> UAE Central Bank mortgage guidelines (Q1 2026)</p>
            </>
        ),
    },
    {
                        ...
                        <tbody className="divide-y" style={{ borderColor: 'rgba(0,0,0,0.08)' }}>
                            {[
                                ...
                                <tr key={comp} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-3 py-2 text-xs" style={{ color: 'rgba(0,0,0,0.5)' }}>{note}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
    ...
    // Verification & Due Diligence
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> Dubai Land Department (DLD), Dubai REST app</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs"><strong>Source:</strong> RTA infrastructure records, Dubai 2040 Master Plan (Q1 2026)</p>
            </>
        ),
    },
];
