...
const ExpertSection = () => {
    ...
    return (
        <div className={`mt-4 border rounded-2xl p-3 md:p-5 transition-colors duration-300 ${isDark ? 'border-slate-700 bg-slate-900' : 'border-[#e8e1d5]'}`}>
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                ...
                <div className="flex items-center gap-3 w-full md:w-1/2 justify-center md:justify-start text-center md:text-left">
                    ...
                    <div>
                        ...
                        <p className={`text-[10px] mt-1 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>Get expert guidance. It's free & no obligation.</p>
                    </div>
                </div>

                <div className={`md:hidden w-full h-[1px] ${isDark ? 'bg-slate-700' : 'bg-[#eee4d7]'}`} />
                <div className={`hidden md:block w-[1px] h-14 self-center ${isDark ? 'bg-slate-700' : 'bg-[#eee4d7]'}`} />
                ...
                <div className="grid grid-cols-3 gap-2 md:gap-4 w-full md:w-1/2">
                    <div className="flex flex-col items-center text-center cursor-pointer group">
                        ...
                        <p className={`text-[13px] font-bold ${isDark ? 'text-white' : 'text-slate-800'}`}>WhatsApp</p>
                        <p className={`text-[10px] ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>Chat instantly</p>
                    </div>

                    <div className={`flex flex-col items-center text-center ${isDark ? 'border-slate-700' : 'border-[#eee4d7]'} border-x md:border-x-0 px-2 cursor-pointer group`}>
                        <div className="w-11 h-11 rounded-full border border-[#b07d2d] flex items-center justify-center text-[#b07d2d] mb-1 group-hover:bg-[#b07d2d] group-hover:text-white transition-colors">
                            <FiPhoneCall className="w-6 h-6" />
                        </div>
                        <p className={`text-[13px] font-bold ${isDark ? 'text-white' : 'text-slate-800'}`}>Call Us</p>
                    ...
                    <div className="flex flex-col items-center text-center cursor-pointer group">
                        ...
                        <p className={`text-[13px] font-bold ${isDark ? 'text-white' : 'text-slate-800'}`}>Email Us</p>
