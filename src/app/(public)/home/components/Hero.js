                    ...
                    <div className="flex-1 min-w-0 w-full">
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center gap-2 font-bold text-[#B38B3F]">
                                    ...
                                    <div>
                                        <p className={`lg:hidden font-bold ${isDark ? "" : "text-[#8B6E3D]"}`} style={isDark ? { color: t.textSecondary } : undefined}>Analyst Verification</p>
                                        <span className={isDark ? "" : "text-slate-700"} style={isDark ? { color: t.text } : undefined}>PropertyIntel Research Team</span>
                                    </div>
                                </div>
                                <div className={`hidden lg:block w-px h-3 ${isDark ? "" : "bg-slate-300"}`} style={isDark ? dk.divider : undefined} />
                                <span className={isDark ? "" : "text-slate-500"} style={isDark ? { color: t.textMuted } : undefined}>Verified: 21 February 2026</span>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            {activeTab === 'performance' ? (
                                <div className="lg:py-2 flex flex-col lg:flex-row items-stretch">
                                    ...
                                    <div
                                        className={`flex items-center lg:items-start justify-between lg:justify-start lg:flex-1 gap-4 lg:gap-3 xl:gap-5 p-4 lg:pr-2 lg:py-4 border-b lg:border-b-0 lg:border-r transition-colors duration-300 ${isDark ? "" : "border-gray-100"}`}
                                    ...
                                    >
                                        <div className="flex gap-3 xl:gap-4 items-center lg:items-start">
                                            ...
                                            <div>
                                                <p className={`text-[12px] xl:text-[14px] font-bold leading-tight ${isDark ? "" : "text-gray-800"}`} style={isDark ? { color: t.text } : undefined}>Total Projects</p>
                                    ...
                                    {/* Avg. Project Delay */}
                                    <div
                                        className={`flex items-center lg:items-start justify-between lg:justify-start lg:flex-1 gap-4 lg:gap-3 xl:gap-5 p-4 lg:px-4 xl:px-8 lg:py-4 border-b lg:border-b-0 lg:border-r transition-colors duration-300 ${isDark ? "" : "border-gray-100"}`}
                                        style={isDark ? { borderColor: dk.dividerColor } : undefined}
                                    >
                                        <div className="flex gap-3 xl:gap-4 items-center lg:items-start">
                                            <div
                                            ...
                                            <div>
                                                <p className={`text-[12px] xl:text-sm font-bold leading-tight ${isDark ? "" : "text-gray-800"}`} style={isDark ? { color: t.text } : undefined}>Avg. Delay (Last 5)</p>
                                                <div className="flex items-baseline gap-1.5 my-0.5">
                                                    <span className="text-xl xl:text-3xl text-[#B38B3F] font-semibold font-[Merriweather] tabular-nums">3–6</span>
                                                    <span className={`text-[10px] xl:text-xs font-medium ${isDark ? "" : "text-gray-500"}`} style={isDark ? { color: t.textMuted } : undefined}>months</span>
                                                </div>
                                            </div>
                                        </div>
                                        <BsChevronRight className="lg:hidden text-gray-400" />
                                    ...
                                    <div className="flex items-center lg:items-start justify-between lg:justify-start lg:flex-[1.2] gap-4 lg:gap-3 xl:gap-5 p-4 lg:pl-4 xl:pl-8 lg:py-4">
                                        <div className="flex gap-3 xl:gap-4 items-center lg:items-start w-full">
                                            ...
                                            <div className="w-full">
                                                <p className={`text-[12px] xl:text-sm font-bold leading-tight ${isDark ? "" : "text-gray-800"}`} style={isDark ? { color: t.text } : undefined}>Trust Score</p>
                                                <div className="flex items-center gap-2 xl:gap-3 my-0.5">
                                                    <p className="text-xl xl:text-3xl text-[#B38B3F] font-semibold font-[Merriweather] tabular-nums">
                                                        9.0 <span className="text-sm xl:text-2xl text-[#B38B3F]/50">/ 10</span>
                                                    </p>
                                                    <span
                                                        className={`px-2 py-0.5 text-[8px] xl:text-[10px] font-bold rounded-full border transition-colors duration-300 ${isDark ? "" : "bg-[#FDF5E6] text-[#B38B3F] border-[#F5E6CC]"}`}
                                                        style={dk?.excellentBadge}
                                                    >
                                                        EXCELLENT
                                                    </span>
                                                </div>
                                    ...
                                    <div className="hidden lg:block">
                                        <div className="flex flex-col">
                                            {sourceData.map((item, index) => (
                                                <div
                                                    key={index}
                                                    className={`flex items-start py-3 border-t ${isDark ? "" : "border-gray-100"} ${index === sourceData.length - 1 ? `border-b ${isDark ? "" : ""}` : ""}`}
                                                    style={isDark ? { borderColor: dk.dividerColor } : undefined}
                                                >
                        ...
                        >
                            <div className="flex items-center gap-3 mb-4 justify-center">
                                ...
                                <div>
                                    <h4 className={`text-[13px] xl:text-sm leading-tight ${isDark ? "" : "text-slate-900"}`} style={isDark ? { color: t.text } : undefined}>Speak to an Investment Expert</h4>
                                    <p className={`text-[10px] ${isDark ? "" : "text-slate-500"}`} style={isDark ? { color: t.textMuted } : undefined}>Get expert guidance. It's free & no obligation.</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                ...
                                <div className="flex flex-col items-center text-center cursor-pointer group">
                                    ...
                                    <p className={`text-[13px] font-bold ${isDark ? "" : "text-slate-800"}`} style={isDark ? { color: t.text } : undefined}>WhatsApp</p>
                                    <p className={`text-[10px] ${isDark ? "" : "text-slate-600"}`} style={isDark ? { color: t.textMuted } : undefined}>Chat instantly</p>
                                </div>

                                {/* Call */}
                                <div className={`flex flex-col items-center text-center border-x cursor-pointer group ${isDark ? "" : "border-[#eee4d7]"}`} style={isDark ? { borderColor: dk.dividerColor } : undefined}>
                                    <div className={`w-11 h-11 rounded-full border flex items-center justify-center mb-1 group-hover:bg-[#b07d2d] group-hover:text-white transition-colors ${isDark ? "" : "border-[#b07d2d] text-[#b07d2d]"}`} style={isDark ? dk.expertIcon : undefined}>
                                        <FiPhoneCall className="w-6 h-6" />
                                    </div>
                                    <p className={`text-[13px] font-bold ${isDark ? "" : "text-slate-800"}`} style={isDark ? { color: t.text } : undefined}>Call Us</p>
                                    <p className={`text-[10px] ${isDark ? "" : "text-slate-600"}`} style={isDark ? { color: t.textMuted } : undefined}>Speak directly</p>
                                </div>
                                ...
                                <div className="flex flex-col items-center text-center cursor-pointer group">
                                    ...
                                    <p className={`text-[13px] font-bold ${isDark ? "" : "text-slate-800"}`} style={isDark ? { color: t.text } : undefined}>Email Us</p>
                                    <p className={`text-[10px] ${isDark ? "" : "text-slate-600"}`} style={isDark ? { color: t.textMuted } : undefined}>We'll get back</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="hidden lg:block w-[310px] xl:w-[360px] shrink-0 sticky top-4">
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    className={`relative w-full h-2 rounded-full mt-6 ${isDark ? "" : "bg-white"}`}
                                    style={dk?.track}
                                >
                                ...
                                <div className="mt-8 xl:mt-10 flex gap-3 xl:gap-4">
                                    ...
                                    <div>
                                        <h4 className={`font-bold text-[13px] xl:text-sm ${isDark ? "" : "text-slate-900"}`} style={isDark ? { color: t.text } : undefined}>Top Tier Developer</h4>
                                        <p className={`text-[10px] xl:text-[11px] mt-1 leading-normal ${isDark ? "" : "text-slate-500"}`} style={isDark ? { color: t.textMuted } : undefined}>Proven track record in delivery and transparency</p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-6 xl:mt-8 flex gap-3 xl:gap-4 items-center">
                                    ...
                                    <div>
                                        <h4 className={`font-bold text-[13px] xl:text-sm ${isDark ? "" : "text-slate-900"}`} style={isDark ? { color: t.text } : undefined}>Verified Research</h4>
                                        <p className={`text-[10px] xl:text-[11px] mt-1 leading-normal ${isDark ? "" : "text-slate-500"}`} style={isDark ? { color: t.textMuted } : undefined}>Updated Feb 2026</p>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        {/* WhatsApp */}
                                        <div className="flex flex-col items-center text-center cursor-pointer group">
                                            <div className={`w-11 h-11 rounded-full border flex items-center justify-center mb-1 group-hover:text-white transition-colors ${isDark ? "group-hover:bg-[#b07d2d]" : "border-[#b07d2d] text-[#b07d2d] group-hover:bg-[#b07d2d] group-hover:text-white"}`} style={isDark ? dk.expertIcon : undefined}>
                                                <BsWhatsapp className="w-6 h-6" />
                                            </div>
                                            <p className={`text-[13px] font-bold ${isDark ? "" : "text-slate-800"}`} style={isDark ? { color: t.text } : undefined}>WhatsApp</p>
                                            <p className={`text-[10px] ${isDark ? "" : "text-slate-600"}`} style={isDark ? { color: t.textMuted } : undefined}>Chat instantly</p>
