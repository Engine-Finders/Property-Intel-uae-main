...
const faqs = [
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500"><strong>Source:</strong> Emaar Annual Report 2025, DLD handover records, DFM filings (Last updated: 22 February 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500"><strong>Note:</strong> Payment terms vary by project, launch phase, and promotions. All off-plan funds are held in RERA-regulated escrow accounts. <strong>Source:</strong> Emaar official website, RERA off-plan sales guidelines (Last updated: 22 February 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500"><strong>Source:</strong> DLD handover records 2020-2025, Emaar project announcements, Dubai Invest (Last updated: 22 February 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500">These charges are regulated by RERA and published via the DLD Mollak portal. Emaar Community Management typically adjusts charges annually by ~2-4%. <strong>Source:</strong> DLD Mollak Service Charge Index 2025 (Last updated: 22 February 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500"><strong>Source:</strong> Dubai Land Department, Emaar sales terms, UAE residency regulations (Last updated: 22 February 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500"><strong>Source:</strong> ValuStrat UAE Developer Comparison 2025, DLD transaction data (Last updated: 22 February 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500"><strong>Source:</strong> DLD 2025 transaction data, Emaar sales reports, Google Trends UAE (Last updated: 22 February 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500"><strong>Source:</strong> Emaar project brochures 2025-2026, authorized agent disclosures (Last updated: 22 February 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500"><strong>Source:</strong> Google Reviews / PropertyFinder.ae / Bayut.com aggregation (2025-2026) (Last updated: 22 February 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500"><strong>Source:</strong> DLD buyer's guide, Emaar sales process documentation, RERA regulations (Last updated: 22 February 2026)</p>
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                <p className="mt-3 text-xs text-gray-500"><strong>Source:</strong> ValuStrat Price Index Q4 2025, PropertyIntel rental yield analysis (Last updated: 22 February 2026)</p>
            </>
        ),
    },
];
        ...
        <section className="w-full bg-[#FCFBFA] py-2 sm:py-5 font-sans antialiased text-[#1A1A1A]">
            <div className="max-w-[1400px] mx-auto px-4">
                <div className="flex flex-col items-center justify-center text-center">
                    <h2 className="text-3xl lg:text-4xl font-serif text-[#1A1A1A] mb-2">Frequently Asked Questions About <span className="text-[#B68A35]">Emaar Properties</span></h2>
                    <p className="text-gray-600 mb-6 max-w-2xl text-center mx-auto">Find answers to the most common questions about buying from Emaar, payment plans, delivery track record, and more.</p>
                </div>
                    ...
                    <div className="divide-y divide-gray-100">
                        {faqs.map((item, idx) => (
                            <div key={idx} className="py-2 sm:py-4">
                                ...
                                >
                                    <div className="w-12 shrink-0 text-[#B68A35] font-bold text-lg font-[Merriweather] tabular-nums">{String(idx + 1).padStart(2, '0')}.</div>

                                    <div className="flex-1">
                                        <div className="flex items-center justify-between">
                                            <h3 className="text-sm font-semibold text-gray-800">{item.q}</h3>
                                            <div className="w-5 h-5 shrink-0 flex items-center justify-center">
                                                <ChevronDown className={`w-full h-full transition-transform duration-200 transform ${openIndex === idx ? 'rotate-180' : ''}`} />
                                            </div>
                                        </div>

                                        <div className={`mt-3 text-sm text-gray-600 overflow-hidden transition-[max-height] duration-300 ${openIndex === idx ? 'max-h-screen' : 'max-h-0'}`}>
                                            {item.a}
                                        </div>
                                    </div>
                                </button>
