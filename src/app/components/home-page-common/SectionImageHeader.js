    ...
    <div
      ...
      style={{
        background: t.isDark
          ...
          : "linear-gradient(90deg, #fffdfa 0%, #fffdfa 42%, rgba(255,253,250,0.72) 60%, rgba(255,253,250,0.22) 78%, transparent 100%)",
      }}
      aria-hidden="true"
    />
    <div className={`relative z-10 max-w-[590px] px-8 py-12 ${contentClassName}`}>
