  ...
  <div className="border-b" style={{ borderColor: t.cardBorder }}>
    ...
    >
      <div className="pb-4 space-y-2">
        ...
        {faq.source && (
          <p className="text-[10px] italic mt-3" style={{ color: t.textMuted }}>Source: {faq.source}</p>
        )}
      </div>
    </div>
  </div>
  ...
  return (
    <section id="home-faq" className="py-8 lg:py-12 px-4 sm:px-6 lg:px-8" style={{ background: t.bgAlt }}>
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <span className="inline-block text-[10px] font-bold tracking-[0.2em] uppercase px-3 py-1 rounded-full mb-4" style={{ background: "#B68A3520", color: GOLD }}>
            {data.badge}
          </span>
        ...
        {/* Disclaimer */}
        <p className="text-[10px] leading-relaxed text-center max-w-3xl mx-auto" style={{ color: t.textMuted }}>
          {data.note}
        </p>
      </div>
    </section>
